...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            var methodSyntax =
                Emps
                    .Where(e => e.Salary.Equals(maxSalary));
            IEnumerable<Emp> result = methodSyntax;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.MethodTask12();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            var methodSyntax =
                Depts
                    .Where(d => Emps.Count(e => e.Deptno.Equals(d.Deptno)) == 5 || !Emps.Any(e => e.Deptno.Equals(d.Deptno)))
                    .OrderBy(d => d.Dname);
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> MethodTask12(this IEnumerable<Emp> Emps)
        {
            var result = 
                Emps
                .Where(e => Emps.Count(es => es.Mgr != null && es.Mgr.Equals(e)) >= 1)
                .OrderBy(e => e.Ename)
